(function() {
  ...
  Builder = (function() {
    ...
    Builder.prototype.build = function() {
      ...
      console.log("Output dir for compilation: " + this._absoluteOutputDir);
      ...
      if (path.existsSync(this._absoluteOutputDir) && srcDirsToInclude.length > 0) {
        return run("coffee -o " + this._absoluteOutputDir + " -c " + (srcDirsToInclude.join(" ")), function(err, stdout, stderr) {
            ...
            _results.push((function(dir) {
              return glob("" + dir + "/**/*.js", {}, function(er, files) {
                ...
                for (_j = 0, _len2 = files.length; _j < _len2; _j++) {
                  ...
                  pathToCreate = path.join(_this._absoluteOutputDir, path.dirname(filePathSansInputDir));
                  ...
                  _results2.push(run("mkdir -p " + pathToCreate, function(err, stdout, stderr) {
                    ...
                    return run("cp " + file + " " + (path.join(_this._absoluteOutputDir, filePathSansInputDir)));
                  }));
                }
                return _results2;
              });
        ...
        return console.log("No output dir, or no sources to build. Output dir: " + this._absoluteOutputDir + "; Input dirs: " + this._absoluteInputDirs + " for build: " + this._buildName);
      }
    };
